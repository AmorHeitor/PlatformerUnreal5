...
#include "PlatformGame/MovingPlatform.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMovingPlatform() {}
// Cross Module References
	PLATFORMGAME_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
	PLATFORMGAME_API UClass* Z_Construct_UClass_AMovingPlatform();
...
// End Cross Module References
	...
	template<> PLATFORMGAME_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMovingPlatform);
	struct Z_CompiledInDeferFile_FID_PlataformGame_Source_PlatformGame_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PlataformGame_Source_PlatformGame_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 2314687878U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PlataformGame_Source_PlatformGame_MovingPlatform_h_2706934370(TEXT("/Script/PlatformGame"),
		Z_CompiledInDeferFile_FID_PlataformGame_Source_PlatformGame_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PlataformGame_Source_PlatformGame_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
